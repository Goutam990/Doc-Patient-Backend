...
namespace Doc_Patient_Backend.Migrations
{
    public partial class InitialCreate : Migration
    {
        ...
        {
            // Identity Tables (Standard Structure)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailabilityHours_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRevisit = table.Column<bool>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    UpdatedAt = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_PatientInfos_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedBy = table.Column<int>(nullable: false),
                    OldTime = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientInfos_PhoneNumber",
                table: "PatientInfos",
                column: "PhoneNumber",
                unique: true);
        }
        ...
        {
            migrationBuilder.DropTable(name: "AppointmentLogs");
            migrationBuilder.DropTable(name: "AvailabilityHours");
            migrationBuilder.DropTable(name: "Payments");
            migrationBuilder.DropTable(name: "Appointments");
            migrationBuilder.DropTable(name: "PatientInfos");
